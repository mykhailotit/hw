...
class MovieDataProcessor:
    ...
    def _fetch_genres(self):
        """Завантаження жанрів та формування мапи id → назва жанру"""
    ...
    def _fetch_movies(self):
        """Завантаження фільмів з усіх сторінок"""
        ...
        self.original_movies = list(self.movies)  # Зберігаємо оригінал
    ...
    def get_unique_genres(self):
        """Повертає унікальні жанри як незмінну множину (frozenset)"""
    ...
    def delete_movies_by_genre(self, genre_name):
        """Видаляє всі фільми з заданим жанром"""
    ...
    def get_grouped_titles_by_genres(self):
        """Групування пар фільмів по спільному жанру"""
